...
<div>
    ...
    <a onclick='validarPuntaje();' target="_blank"><input type="button"  value="Generar"/></a>
  	...
  	<div id="contenedor">
		<h1>Parcial Manual</h1>
        <div id="carpetas" style="float:left; width:35%; background:#CCC; font-size: 18px; height:600px; text-align:center;">
            <div align="left">
                <input name="opcion" id="opcion1" type="radio" class="margen_izq" value="Práctica" checked/>Práctica<br /><br />
                <input name="opcion" id="opcion2" type="radio" class="margen_izq" value="Taller" />Taller<br/><br />
                <input name="opcion" id="opcion3" type="radio" class="margen_izq" value="Quiz" />Quiz<br/><br />
            </div>
            ...
            <input type="button" value="Vista Previa" style="margin: 0 auto" onclick="vistaPrevia('mostrarVistaPrevia.php',verSeleccionado());" />
        </div>
