<?php
	...
	{
		$query="INSERT INTO enunciado(`ci_crea_en`, `descripcion`,`nivel`,`componente`,`nombre_sub`, `fec_creacion`, `solucion`, `visibilidad`) VALUES ('".$row['ci']."','".$descripcion."','".$nivel."','".$componente."','".$subtema."','".date('Y-m-d')."', '".$solucion."', '".$visib."')";
